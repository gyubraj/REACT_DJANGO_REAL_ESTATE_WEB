...
const ListingForm = (props) => {
    ...
    const onCheckBoxChange = e => {
        let open_house = false
        if (e.target.checked) {
            open_house = true
        };
        setFormData({ ...formData, open_house: open_house });
    }
            ...
            <div className='row'>
                ...
                <div className='col-1-of-6'>
                    ...
                    <div className='listingform__altsection'>
                        ...
                        <input className='listingform__checkbox' name='open_house' type='checkbox' onChange={e => onCheckBoxChange(e)} value={open_house} />
                    </div>
                </div>
